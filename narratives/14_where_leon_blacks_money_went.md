...
|---------------|-------|
| Leon Black | 1,600 |
| Leon Black [with date headers] | 473 |
| Black Family Partners | 400 |
| Leon Black's | 260 |
| Ada Clapp / Elysium Management | 176 |
| Leon Black [with subject headers] | 172 |
| Ada Clapp / Black Family Partners | 155 |
| Elysium Management LLC | 96 |
| Eileen Alexanderson / Elysium Management | 55 |
| Elysium Management | 44 |
| Leon & Debra | 17 |
...
Black's document footprint intersects with every major entity in the Epstein shell network:

| Shell Entity | Shared Files with Black Variants |
|-------------|--------------------------------|
| **Southern Trust Company** | **60** |
| **Financial Trust Company** | **46** |
| Haze Trust | 11 |
| Jeepers, Inc. | 10 |
| Gratitude America | 8 |
| Southern Financial LLC | 6 |
| Epstein & Co Inc. | 6 |
...
|------------|------------------------------------------|
| **Apollo Management** | **13** |
| **Elysium Management LLC** | **9** |
| **Coatue Enterprises** | **6** |
| **Apollo Global Management** | **4** |
| **Boothbay Multi-Strategy Fund** | **4** |
| **Honeycomb** | **4** |
| **Valar Global Fund II** | **4** |
| BV70 LLC | 2 |
| Narrow Holdings LLC | 2 |
| Valar Global Fund III | 2 |
| Honeycomb Ventures IV LP | 2 |
| Honeycomb Partners LP | 2 |
| Boothbay Absolute Strategies Fund | 4 (variants) |
| Black Family Partners LP c/o Apollo Management | 2 |

Apollo Management — the firm Leon Black founded and led — appears on **13 financial documents** alongside Southern Trust Company. That means Epstein's primary shell was transacting directly with Black's own firm.

And then there's the line that connects it explicitly: **"Black Family Partners LP c/o Apollo Management"** appears on 2 Southern Trust Company financial documents. That is Black's family office, at Apollo's address, on Epstein's shell company's financial records.
...
The EFTA documents show a network. The Dechert review examined a single line within it.

## Narrow Holdings and BV70

Two entities in the Black constellation deserve specific mention. **Narrow Holdings LLC** appears on 2 Southern Trust financial documents with the notation "c/o Elysium Management" — meaning Narrow Holdings was addressed through Black's management company. **BV70 LLC** also appears on 2 Southern Trust financial documents. Both are corporate vehicles associated with the Black financial ecosystem.

Their presence on Southern Trust Company records places them inside the Epstein shell network's financial infrastructure, not adjacent to it.
...
|----------|--------|-------------|
| <a href="https://www.justice.gov/epstein/files/DataSet%208/EFTA00027019.pdf" target="_blank">EFTA00027019</a> | DS8 | Deutsche Bank-SDNY Production: Exhibit A — 12 Black-entity transfers to Southern Trust ($60.5M verified) |
| Full EFTA Corpus | DS1–12 | Leon Black: 1,600 file matches across all datasets |
| <a href="https://www.apollo.com/~/media/Files/A/Apollo-V3/documents/dechert-report.pdf" target="_blank">Dechert LLP Independent Review (2021)</a> | External | Dechert LLP independent review — $158–170M total Black-to-Epstein payments |
| <a href="https://www.justice.gov/epstein/doj-disclosures/data-set-8-files" target="_blank">Dataset 8</a> | DS8 | Browse Dataset 8 |
| <a href="https://www.justice.gov/epstein/doj-disclosures/data-set-9-files" target="_blank">Dataset 9</a> | DS9 | Browse Dataset 9 |
