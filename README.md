...
> 
> This repository is a published output of an active forensic investigation. The underlying database is under continuous review — records are re-validated against primary bank documents, entities are reclassified as new source material is processed, and figures are corrected when the data demands it. What you are reading reflects the state of the analysis as of **March 20, 2026**.
>
> If you are forking, archiving, or citing this work: snapshots capture a moment in time. Do not treat cached versions as authoritative. Always reference the live repository for current figures. Last validated: **March 20, 2026**.
...
> **2 data narratives** reconstruct how $2.146 billion moved through 14 shell entities across 8+ banking institutions. All figures reflect the deduplication-verified publication ledger (6,310 unique records as of March 11, 2026). Every claim is anchored to specific court exhibits and bates stamps.
>
...
| **T1–T3 Coverage of SAR** | **104.4%** ($1,960,500,000) |
...
| **T1–T3** | **Auditable Subtotal** | **$1,960,500,000** | **104.4% of SAR** |
...
- `publication_ledger` — 6,310 deduplicated transactions ($2.146B, dedup_status='UNIQUE') with four-tier GAGAS classification (T1–T4), payment type, source exhibit
...
Phase 5L   Publication Ledger Assembly → 6,310 unique transactions (dedup-verified), $2.146B, four-tier GAGAS framework
```
...
| **5L** | **Publication ledger: 6,310 dedup-verified transactions, four-tier GAGAS, T1–T3 = 104.4% SAR** | **$2.146B total** |
...
| Feb 25 | Phase 5K–5L: Payment type expansion + publication ledger assembly. 10,964 raw records assembled; 6,310 dedup-verified unique transactions, $2.146B, four-tier GAGAS framework |
